...
Просто напишите в чат что нужно исследовать — координатор (главный агент) сам определит что нужен ресёрч, составит brief, обсудит с вами и запустит субагент-researcher.
